...
This file is what I do and don't do. [AGENTS.md](./AGENTS.md) is the workflow I
...
[AGENTS.md](./AGENTS.md) and [setup-repo.sh](./setup-repo.sh) have the details of
which of those are blocked outright and which are just rules I follow.
